...
export class EnergyAccountDetails extends React.Component<Props, State> {
    ...
    componentDidUpdate(prevProps: Props) {
        if (prevProps.energyAccount != this.props.energyAccount) {
    ...
    fetchIntervalsNight(startTimeStamp?: string, endTimeStamp?: string) {
        ...
        console.log(url);
        console.log(this.props.energyAccount.id);
        console.log(this.props.energyAccount.address);
        ...
        fetch(url, requestOptions)
            ...
            .then((data) => {
                ...
                setTimeout(() => { this.calculateBoth(); }, 1000);


                console.log('called intervalsnight');
                console.log(this.state.intervalDataNight);
