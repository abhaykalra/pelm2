...
export const EnergyAccountBrowser = (props: Props) => {
    ...
    const onEnergyAccountSelect = (evt: SelectChangeEvent<number>) => {
        ...
        let acc = props.energyAccounts.find(acc => acc.id == _ID);
        //props.selectedEnergyAccount = acc;
        props.onEnergyAccountSelect(acc!);
        console.log("selectedEnergyAccount: running in browser");
        console.log(props.selectedEnergyAccount);
        console.log(acc);
    }
